...
class PortfolioData {
  ...
  static const String shortTitle = 'Mobile Engineer';
  ...
  static const String heroTagline = 'I am a Senior Mobile Engineer.';
  static const String heroSubtitle = 'I build apps, like this website!';

  static const String aboutParagraph1 =
      'I am a driven, self-taught Senior Mobile Engineer with 6+ years designing, building, and shipping cross-platform applications for iOS, Android, and Web across defense, healthcare, logistics, and enterprise SaaS. I work across the full mobile stack — React Native, Flutter, and native Swift and Kotlin — along with deep platform integration, Bluetooth and hardware interfacing, wearables, real-time data systems, and end-to-end release management on the App Store and Google Play. I have shipped everything from classified battlefield communication tools to consumer apps serving 500,000+ users.';
  ...
  static const List<EducationItem> education = [
    ...
    EducationItem(
      ...
      degree: 'Bachelor of Science in Recreation, Sports, & Parks Administration',
  ...
  static final List<ProjectModel> projects = [
    ...
    ProjectModel(
      ...
      description:
          'Describe the run you want - the distance, the vibe, the terrain - and RunRouteAI turns it into a real, followable route on the map. An LLM parses your description into structured route preferences, then the Mapbox Directions and Optimization APIs generate a route matched to your target distance, with optional loops back to your start. Live GPS tracking snaps your position to the route and shows real-time distance, time, and pace. Built with Flutter, Mapbox, Riverpod, and Drift.',
      images: [
